...
TARGET = dictionary
programa = match-regular-expression.o linea.o trie-tree.o files-helper.o convert-lineas-in-to-trie.o get-inputed.o string-formating-utils.o create-tree-by-filename.o migrate-default-trie-dictionary.o\
