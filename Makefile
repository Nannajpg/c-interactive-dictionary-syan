...
TARGET = dictionary
programa =  match-regular-expression.o linea.o trie-tree.o get-inputed.o string-formating-utils.o create-tree-by-filename.o\
			migrate-default-trie-dictionary.o command-dispatch.o get-error.o errors-helper.o get-command-by-input.o execute-quit-command.o\
